...
def fetch_evolucion_ajax(request):
    ...
    try:
        ...
        if region_code == 'METROPOLITANA':
            print("--- DEVOLVIENDO DATOS 'HARDCODEADOS' (1950-2025) PARA METROPOLITANA ---")
        ...
        # ==================================================
        # ✅ LÓGICA "AUTOMÁTICA" (para OTRAS regiones)
        # ==================================================
        else:
            ...
            # Usa la función ayudante para procesar la respuesta de la API
        ...
        # ✅ CORRECCIÓN: Eliminamos el print() que podía crashear el servidor
        return JsonResponse({'success': False, 'message': f'Error inesperado del servidor.'}, status=500)